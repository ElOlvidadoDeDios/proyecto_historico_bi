...
-- Modifica la sección de CTE_CARTERA_MORAS para que quede así:
CTE_CARTERA_MORAS AS (
    ...
    WHERE T_PRE.PERIODO = :periodo 
      -- Candado de exclusión estricto:
      AND T_ANA.ID_USER NOT IN ('PRECASTIGO', 'RJULI6', 'RJULIACA', 'RLIMA7', 'RQUILLA3', 'RSICUA4', 'LHR5', 'HTEJ5', 'TKPN5', 'GHVJ5', 'OTA5', 'SDHF5', 'CMN5', 'HQND5')
    GROUP BY T_PRE.PERIODO, T_ANA.ID_USER
),
CTE_DURACION AS (
