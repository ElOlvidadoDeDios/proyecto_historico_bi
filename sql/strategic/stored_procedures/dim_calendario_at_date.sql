...
CREATE OR ALTER PROCEDURE [dbo].[dim_calendario_at_date]
AS
BEGIN
    SET NOCOUNT ON;
        ...
        SELECT
            ...
            CASE
                WHEN @fecha_inicio IN (
                    ...
                    DATEFROMPARTS(@anio, 6, 7),   -- Batalla de Arica y Día de la Bandera   [NUEVO]
                    DATEFROMPARTS(@anio, 6, 29),  -- San Pedro y San Pablo
                    DATEFROMPARTS(@anio, 7, 23),  -- Día de la Fuerza Aérea del Perú         [NUEVO]
                    DATEFROMPARTS(@anio, 7, 28),  -- Fiestas Patrias
                    DATEFROMPARTS(@anio, 7, 29),  -- Fiestas Patrias
                    DATEFROMPARTS(@anio, 8, 6),   -- Batalla de Junín                         [NUEVO]
                    ...
                    DATEFROMPARTS(@anio,12, 9),   -- Batalla de Ayacucho                      [NUEVO]
